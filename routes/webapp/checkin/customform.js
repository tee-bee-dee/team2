...
/**
 * @api {render} customform.makeDropdown
 * @apiName makeDropdown
 * @apiGroup Create Form
 * @apiDescription Creates a dropdown menu based on templates
 *
 *
 * @apiParam {List} options of forms to add to the dropdown menu
 * @apiParam {string} name of group of forms to create as
 * @apiParam {string} form body (used to prefill form)
 */
...
/**
 * @api {render} customform.makeDropdown Enter form text
 * @apiName Create text field
 * @apiGroup Create Form
 * @apiDescription Create form html tag with body and title name
 *
 * @apiParam {String} name of the input tag
 ...
 * @apiName makeForm
 * @apiGroup Create Form
 * @apiDescription Find the appropriate form for the given business and create
 *
 * @apiParam db The MongoDB object
 * @apiParam businessId The id for the business
 * @apiParam body The form body (used to prefill form)
 * @apiParam fn Callback function `fn(formHtml)`
 */
