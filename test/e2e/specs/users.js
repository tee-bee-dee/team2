...
module.exports = {
    'Running test to add an employee' : function (client) {
        ...
        client
            ...
            .waitForElementVisible('ul li:nth-child(4)', 1000)
            .waitForElementVisible('ul li:nth-child(4) a', 1000)
            .assert.containsText('ul li:nth-child(4) a', 'Employees')
            .click('ul li:nth-child(4) a', function(clickStatus){
